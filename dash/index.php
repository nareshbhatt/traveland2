...
$sql=  mysqli_query($con,"select * from user_login where sn='$rr'");
  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu" style="margin-right: 50px;">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo $arr['name'];?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="logout.php" class="btn btn-default btn-flat">Sigin out</a>
                </div>
              </li>
            </ul>
          </li>
       ...
       <div class="navbar-custom-menu" style="margin-left: 120px; float: left; ">
        <ul class="nav navbar-nav" >
